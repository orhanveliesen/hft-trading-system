...
TEST(market_buy_fills_at_ask) {
    ...
    auto report = exchange.send_market_order("BTCUSDT", Side::Buy, 1.0,
                                             50000.0, // bid
                                             50010.0, // ask
                                             1000000);
...
TEST(market_sell_fills_at_bid) {
    ...
    auto report = exchange.send_market_order("BTCUSDT", Side::Sell, 2.5,
                                             50000.0, // bid
                                             50010.0, // ask
                                             1000000);
...
TEST(market_order_includes_commission) {
    ...
    auto report = exchange.send_market_order("ETHUSDT", Side::Buy, 10.0,
                                             3000.0, // bid
                                             3001.0, // ask
                                             1000000);
...
TEST(limit_order_goes_to_pending) {
    ...
    auto report = exchange.send_limit_order("BTCUSDT", Side::Buy, 1.0,
...
TEST(limit_buy_fills_when_ask_drops_below_limit) {
    ...
    exchange.send_limit_order("BTCUSDT", Side::Buy, 1.0,
                              50000.0, // limit price
                              1000000);
    ASSERT_EQ(exchange.pending_count(), 1u);
...
TEST(limit_sell_fills_when_bid_rises_above_limit) {
    ...
    exchange.send_limit_order("BTCUSDT", Side::Sell, 2.0,
                              50000.0, // limit price
                              1000000);
    ASSERT_EQ(exchange.pending_count(), 1u);
...
TEST(cancel_pending_order) {
    ...
    auto new_report = exchange.send_limit_order("BTCUSDT", Side::Buy, 1.0, 49000.0, 1000000);
    ASSERT_EQ(exchange.pending_count(), 1u);
...
TEST(max_pending_orders_enforced) {
    ...
    auto report = exchange.send_limit_order("BTCUSDT", Side::Buy, 1.0, 39000.0, 9999999);

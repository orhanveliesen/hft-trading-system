...
struct alignas(64) TradeEvent {
    ...
    // Helper methods
    void clear() { std::memset(this, 0, sizeof(TradeEvent)); }
    ...
    static TradeEvent quote(uint32_t seq, uint64_t ts, uint32_t sym, const char* tick, double bid, double ask) {
        TradeEvent e;
        e.clear();
        e.sequence = seq;
        e.timestamp_ns = ts;
    ...
    static TradeEvent fill(uint32_t seq, uint64_t ts, uint32_t sym, const char* tick, uint8_t side, double price,
    ...
    static TradeEvent target_hit(uint32_t seq, uint64_t ts, uint32_t sym, const char* tick, double entry, double exit,
    ...
    static TradeEvent stop_loss(uint32_t seq, uint64_t ts, uint32_t sym, const char* tick, double entry, double exit,
                                double qty, double pnl_value) {
        TradeEvent e;
        e.clear();
        e.sequence = seq;
    ...
    static TradeEvent signal(uint32_t seq, uint64_t ts, uint32_t sym, const char* tick, uint8_t side, uint8_t strength,
                             double price) {
        TradeEvent e;
        e.clear();
        e.sequence = seq;
    ...
    static TradeEvent regime_change(uint32_t seq, uint64_t ts, uint32_t sym, const char* tick, uint8_t new_regime) {
        TradeEvent e;
        e.clear();
        e.sequence = seq;
        e.timestamp_ns = ts;
    ...
    static TradeEvent status(uint32_t seq, uint64_t ts, uint32_t sym, const char* tick, StatusCode code,
                             double price = 0, uint8_t sig_strength = 0, uint8_t regime_val = 0) {
        TradeEvent e;
        e.clear();
        e.sequence = seq;
        e.timestamp_ns = ts;
    ...
    static TradeEvent tuner_config(uint32_t seq, uint64_t ts, uint32_t sym, const char* tick, StatusCode code,
                                   uint8_t confidence = 0, TunerConcern concern = TunerConcern::None,
                                   TunerParam param = TunerParam::None, double old_value = 0, double new_value = 0) {
        TradeEvent e;
        e.clear();
        e.sequence = seq;
        e.timestamp_ns = ts;
    ...
    TunerConcern get_tuner_concern() const { return static_cast<TunerConcern>(side); }

    TunerParam get_tuner_param() const { return static_cast<TunerParam>(regime); }

    StatusCode get_status_code() const { return static_cast<StatusCode>(status_code); }

    static const char* status_code_name(StatusCode code) {
        switch (code) {
        case StatusCode::None:
            return "None";
        case StatusCode::Heartbeat:
            return "Heartbeat";
        case StatusCode::IndicatorsWarmup:
            return "IndicatorsWarmup";
        case StatusCode::CashLow:
            return "CashLow";
        case StatusCode::TradingDisabled:
            return "TradingDisabled";
        case StatusCode::VolatilitySpike:
            return "VolatilitySpike";
        case StatusCode::DrawdownAlert:
            return "DrawdownAlert";
        case StatusCode::AutoTunePaused:
            return "AutoTunePaused";
        case StatusCode::AutoTuneRelaxed:
            return "AutoTuneRelaxed";
        case StatusCode::AutoTuneCooldown:
            return "AutoTuneCooldown";
        case StatusCode::AutoTuneSignal:
            return "AutoTuneSignal";
        case StatusCode::AutoTuneMinTrade:
            return "AutoTuneMinTrade";
        case StatusCode::TunerConfigUpdate:
            return "TunerConfigUpdate";
        case StatusCode::TunerPauseSymbol:
            return "TunerPauseSymbol";
        case StatusCode::TunerResumeSymbol:
            return "TunerResumeSymbol";
        case StatusCode::TunerEmergencyExit:
            return "TunerEmergencyExit";
        default:
            return "Unknown";
        }
    }
    ...
    static const char* concern_name(TunerConcern concern) {
        switch (concern) {
        case TunerConcern::None:
            return "";
        case TunerConcern::LowWinRate:
            return "LowWinRate";
        case TunerConcern::HighCosts:
            return "HighCosts";
        case TunerConcern::Drawdown:
            return "Drawdown";
        case TunerConcern::VolatilitySpike:
            return "Volatility";
        case TunerConcern::LowActivity:
            return "LowActivity";
        case TunerConcern::HighActivity:
            return "HighActivity";
        case TunerConcern::SpreadWidening:
            return "Spread";
        case TunerConcern::RegimeChange:
            return "RegimeChg";
        case TunerConcern::PerformanceDecay:
            return "PerfDecay";
        case TunerConcern::RiskExposure:
            return "RiskExp";
        case TunerConcern::Optimization:
            return "Optimize";
        default:
            return "Unknown";
        }
    ...
    static const char* param_name(TunerParam param) {
        switch (param) {
        case TunerParam::None:
            return "";
        case TunerParam::EmaDevTrend:
            return "EMA_Trend";
        case TunerParam::EmaDevRange:
            return "EMA_Range";
        case TunerParam::EmaDevHvol:
            return "EMA_HVol";
        case TunerParam::BasePosition:
            return "BasePos";
        case TunerParam::MaxPosition:
            return "MaxPos";
        case TunerParam::TargetPct:
            return "Target";
        case TunerParam::StopLossPct:
            return "StopLoss";
        case TunerParam::PullbackPct:
            return "Pullback";
        case TunerParam::Cooldown:
            return "Cooldown";
        case TunerParam::OrderType:
            return "OrdType";
        case TunerParam::OrderOffset:
            return "OrdOffset";
        case TunerParam::OrderTimeout:
            return "OrdTimeout";
        case TunerParam::Enabled:
            return "Enabled";
        case TunerParam::AccumFloorTrend:
            return "AccFloor_T";
        case TunerParam::AccumFloorRange:
            return "AccFloor_R";
        case TunerParam::AccumFloorHvol:
            return "AccFloor_H";
        case TunerParam::AccumBoostWin:
            return "AccBoost";
        case TunerParam::AccumPenaltyLoss:
            return "AccPenalty";
        case TunerParam::AccumSignalBoost:
            return "AccSigBoost";
        case TunerParam::AccumMax:
            return "AccMax";
        default:
            return "Unknown";
        }

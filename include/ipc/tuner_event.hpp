...
struct TunerEvent {
    ...
    // Trade event helpers
    static TunerEvent make_signal(const char* sym, TradeSide side,
                                   double price, double qty, const char* r = nullptr) {
        TunerEvent e;
    ...
    static TunerEvent make_fill(const char* sym, TradeSide side,
                                 double price, double qty, int64_t pnl_cents,
    ...
    static TunerEvent make_config_change(const char* sym, const char* param,
    ...
    static TunerEvent make_regime_change(const char* sym, uint8_t old_r, uint8_t new_r,
                                          double confidence, const char* r = nullptr) {
        TunerEvent e;
    ...
    static TunerEvent make_ai_decision(uint8_t confidence, uint8_t urgency,
                                        uint8_t action, uint32_t latency,
                                        const char* r = nullptr) {
        TunerEvent e;
    ...
    static TunerEvent make_error(const char* component, int32_t code,
                                  bool recoverable, const char* r) {
        TunerEvent e;
    ...
    bool is_system_event() const {
        return static_cast<uint8_t>(type) >= 48;
    }

    // Get type name
    const char* type_name() const {
        switch (type) {
            case TunerEventType::Signal: return "SIGNAL";
            case TunerEventType::Order: return "ORDER";
            case TunerEventType::Fill: return "FILL";
            ...
            case TunerEventType::EmergencyExit: return "EMERGENCY";
            case TunerEventType::AIDecision: return "AI_DECISION";
            case TunerEventType::TuningTrigger: return "TRIGGER";
            case TunerEventType::TuningSkipped: return "SKIP";
            case TunerEventType::RegimeChange: return "REGIME";
            case TunerEventType::NewsEvent: return "NEWS";
            case TunerEventType::VolatilitySpike: return "VOL_SPIKE";
            case TunerEventType::PriceAlert: return "PRICE_ALERT";
            case TunerEventType::Heartbeat: return "HEARTBEAT";
            case TunerEventType::ProcessStart: return "START";
            case TunerEventType::ProcessStop: return "STOP";
            case TunerEventType::Error: return "ERROR";
            case TunerEventType::ConfigReload: return "RELOAD";
    ...
    const char* trigger_name() const {
        switch (trigger) {
            case TriggerReason::None: return "";
            case TriggerReason::Scheduled: return "scheduled";
            case TriggerReason::LossThreshold: return "loss_threshold";
            case TriggerReason::ConsecutiveLosses: return "consecutive_losses";
            case TriggerReason::WinStreak: return "win_streak";
            case TriggerReason::VolatilitySpike: return "volatility_spike";

...
inline bool is_valid_order_id(OrderId id) {
...
inline const char* order_result_to_string(OrderResult result) {
    switch (result) {
        case OrderResult::Success: return "Success";
        case OrderResult::PoolExhausted: return "PoolExhausted";
        case OrderResult::InvalidOrderId: return "InvalidOrderId";
        case OrderResult::InvalidPrice: return "InvalidPrice";
        case OrderResult::InvalidQuantity: return "InvalidQuantity";
        case OrderResult::OrderNotFound: return "OrderNotFound";
        case OrderResult::SystemHalted: return "SystemHalted";
        case OrderResult::DuplicateOrderId: return "DuplicateOrderId";
        case OrderResult::RateLimitExceeded: return "RateLimitExceeded";
        case OrderResult::MaxOrdersExceeded: return "MaxOrdersExceeded";
...
struct Order {
    ...
    __attribute__((always_inline))
    void init(OrderId id_, TraderId trader_, Timestamp ts_, Symbol sym_,
              Price price_, Quantity qty_, Side side_) {
        id = id_;
        trader_id = trader_;
        timestamp = ts_;
        symbol = sym_;
...
struct PriceLevel {
    ...
    __attribute__((always_inline))
    void add_quantity(Quantity amount) {
        total_quantity += amount;
    }

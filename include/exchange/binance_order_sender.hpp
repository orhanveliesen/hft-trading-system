...
public:
    ...
    void register_symbol(Symbol id, const std::string& ticker) { symbol_to_ticker_[id] = ticker; }
...
static_assert(concepts::OrderSender<BinanceOrderSender>, "BinanceOrderSender must satisfy OrderSender concept");
